...
export function PostComposer() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    createPost.mutate({ content: content.trim(), visibility, image });
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        ...
        <div className="form-floating _feed_inner_text_area_box_form">
          <textarea
            ...
            id="postComposerTextarea"
          />
          <label className="_feed_textarea_label" htmlFor="postComposerTextarea">
            Write something ...
      ...
      {image && (
        <div className="_padd_t8">
          <small>Attached: {image.name}</small>{' '}
          <button
            type="button"
            onClick={() => {
              setImage(null);
      ...
      <div className="_feed_inner_text_area_bottom">
        <div className="_feed_inner_text_area_item">
          <div className="_feed_inner_text_area_bottom_photo _feed_common">
            <button type="button" onClick={() => fileInputRef.current?.click()} className="_feed_inner_text_area_bottom_photo_link">
          ...
          <div className="_feed_inner_text_area_bottom_video _feed_common">
            <button type="button" className="_feed_inner_text_area_bottom_photo_link" title="Coming soon">
              <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
        ...
        <div className="_feed_inner_text_area_btn">
          <button type="submit" disabled={createPost.isPending || !content.trim()} className="_feed_inner_text_area_btn_link">
      ...
      {createPost.isError && <p className="text-danger _padd_t8">Failed to create post. Please try again.</p>}
    </form>
  );
}
